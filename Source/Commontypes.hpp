...
using pixel24_t = struct { union { struct { uint8_t R, G, B; }; struct { uint8_t B, G, R; }; uint8_t Raw[3]; }; };
using pixel32_t = struct { union { struct { uint8_t R, G, B, A; }; struct { uint8_t B, G, R, A; }; uint8_t Raw[4]; }; };
